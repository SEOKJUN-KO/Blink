...
const PIPWarningSettings = memo(function PIPWarningSettings({
  isWarningEnabled,
  onToggleWarning,
    ...
    <div className="bg-gradient-to-r from-orange-50 to-amber-50 rounded-2xl p-3 border border-orange-100">
      <div className="space-y-2">
        <div className="flex items-center justify-between">
          <span className="text-xs text-orange-600 font-medium">PIP 경고</span>
          <button
...
export default PIPWarningSettings;
